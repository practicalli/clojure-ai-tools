...
A guide to software Artificial Intelligence tools to support development with the Clojure programming language, using Clojure CLI and a wide range of community tools for a REPL focused workflow.
...
[![Star History Chart](https://api.star-history.com/svg?repos=practicalli/clojure-ai-tools&type=Date)](https://star-history.com/#practicalli/clojure&Date)
